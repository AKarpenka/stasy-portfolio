...
const companies = [
    ...
    },
    {
        ...
        endDate: 'July 1, 2022',
        description: [],
        skills: ['React', 'Redux', 'Node.js', 'SQL', 'Next.js'],
        projects: [
            {
                projectId: 1,
    ...
    },
    {
        ...
        endDate: '',
        description: ['sdfsdfsd sdfsdfsdf sdfsdfsdf'],
        skills: ['React', 'Redux', 'Node.js', 'SQL', 'Next.js'],
        projects: []
    }
]
...
const Experience = () => {
    return (
        <div className="container">
            <p className="experience-title">Work Experience</p>
            {companies.reverse().map((company) => (
                <>
                   <CompayExperience key={company.id} company={company} isLastProject={company.id === companies.length ? true : false} />
                    {company.id !== 1 && <hr/>} 
                </>
            ))}
        </div>
